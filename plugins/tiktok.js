...
cmd({
 ...
 if(!text) return await citel.reply(`*Uhh Please, Provide me tiktok Video Url*\n*_Ex .tiktok https://www.tiktok.com/@silva.edits6/video/7150544062221749531_*`);
 ...
 else return await citel.reply("an error in silva tech server Error While Downloading Your Video") 
})
